        ...
        <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-6">
            <div>
                ...
                <p class="client-section-subtitle">
                    Một số bài viết khác bạn có thể đọc.
                </p>
            </div>
            ...
            <div class="carousel carousel-center w-full space-x-4 rounded-box">
                <?php foreach ($relatedPosts as $item): ?>
                    ...
                    <div class="carousel-item w-72 sm:w-80">
                        <article class="client-card client-card-hover overflow-hidden w-full">
                            ...
                            <div class="p-5">
                                <a href="<?= $relatedPostUrl ?>">
                                    <h3
                                        class="font-extrabold leading-6 h-12 overflow-hidden hover:text-green-700 transition text-slate-950">
                                        <?= htmlspecialchars($item['title']) ?>
                                    </h3>
                                </a>

                                <a href="<?= $relatedPostUrl ?>"
                                    class="h-9 px-4 rounded-full border border-slate-200 hover:bg-green-50 text-slate-800 inline-flex items-center justify-center text-sm font-bold transition mt-4">
                                    Đọc thêm
                                </a>
                            </div>
                        </article>
...
<section class="client-section bg-slate-50">
    <div class="client-shell">
        <div class="mb-6">
            ...
            <p class="client-section-subtitle">
                Video gợi ý sau khi đọc bài viết.
            </p>
        </div>
                ...
                <?php foreach ($latestVideos as $video): ?>
                    <div class="carousel-item w-64 sm:w-72">
                        <a href="index.php?area=client&controller=video&action=index"
                            class="block bg-slate-950 text-white rounded-3xl overflow-hidden w-full hover:-translate-y-1 transition">
