...
<section class="bg-slate-50">
    <div class="client-shell py-6 sm:py-10">
        <?php if (!empty($productHeaderBanners)): ?>
            <div class="carousel w-full rounded-3xl overflow-hidden border border-slate-200 bg-white shadow-sm">
                <?php foreach ($productHeaderBanners as $index => $image): ?>
                    ...
                    <div id="<?= $currentSlide ?>" class="carousel-item relative w-full">
                        ...
                        <div class="absolute inset-0 flex items-center justify-center text-center px-6 text-white">
                            <div class="max-w-2xl">
                                <span
                                    class="inline-flex px-4 py-2 rounded-full bg-white/15 border border-white/20 text-sm font-bold mb-4">
                                    Fresh Market
                                </span>
        ...
        <?php else: ?>
            <div class="carousel w-full rounded-3xl overflow-hidden border border-slate-200 bg-white shadow-sm">
                <div id="product-hero-1" class="carousel-item relative w-full">
                    <div
                        class="w-full min-h-56 sm:min-h-72 bg-gradient-to-br from-green-700 via-green-600 to-lime-400 text-white flex items-center justify-center px-6">
                    ...
                    <div class="absolute flex justify-between left-3 right-3 top-1/2 -translate-y-1/2">
                        <a href="#product-hero-3"
                            class="btn btn-sm sm:btn-md btn-circle bg-white/90 border-0 text-slate-900">❮</a>
                        <a href="#product-hero-2"
                            class="btn btn-sm sm:btn-md btn-circle bg-white/90 border-0 text-slate-900">❯</a>
                    </div>
                </div>
                ...
                <div id="product-hero-2" class="carousel-item relative w-full">
                    <div
                        class="w-full min-h-56 sm:min-h-72 bg-gradient-to-br from-orange-500 to-amber-300 text-white flex items-center justify-center px-6">
                        <div class="text-center max-w-2xl">
                            <div class="text-5xl sm:text-7xl mb-4">🥭🍍🍌</div>
                ...
                <div id="product-hero-3" class="carousel-item relative w-full">
                    <div
                        class="w-full min-h-56 sm:min-h-72 bg-gradient-to-br from-emerald-800 via-teal-700 to-emerald-300 text-white flex items-center justify-center px-6">
                        <div class="text-center max-w-2xl">
                            <div class="text-5xl sm:text-7xl mb-4">🍓🍒🍉</div>
...
<section class="client-section bg-slate-50">
    <div class="client-shell">
        <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-5 mb-6">
            ...
            <form method="GET" class="client-card p-3 grid grid-cols-1 sm:grid-cols-4 gap-3 w-full lg:max-w-3xl">
                ...
                <input type="hidden" name="stock_filter"
                    value="<?= htmlspecialchars($filters['stock_filter'] ?? '') ?>">
                ...
                <select name="sort" class="select select-bordered rounded-full w-full bg-white">
                    ...
                    <option value="price_desc" <?= ($filters['sort'] ?? '') === 'price_desc' ? 'selected' : '' ?>>Giá
                        giảm</option>
                </select>
            ...
            <aside class="lg:col-span-3 xl:col-span-2">
                <div class="lg:sticky lg:top-24 space-y-5">
                    <div class="client-card p-5">
                        <h3 class="font-extrabold text-lg mb-4 text-slate-950">
                            Danh mục
                        </h3>
                        ...
                        <div
                            ...
                            <a href="<?= productFilterUrl([
                                ...
                                class="shrink-0 block px-4 py-3 rounded-full font-bold transition <?= empty($filters['category']) ? 'bg-green-700 text-white' : 'bg-slate-50 hover:bg-green-50 text-slate-700' ?>">
                                Tất cả
                            </a>
                            ...
                            <?php foreach (($categories ?? []) as $category): ?>
                                <a href="<?= productFilterUrl([
                                    ...
                                    class="shrink-0 block px-4 py-3 rounded-full font-bold transition <?= ($filters['category'] ?? '') === $category['slug'] ? 'bg-green-700 text-white' : 'bg-slate-50 hover:bg-green-50 text-slate-700' ?>">
                    ...
                    <div class="client-card p-5">
                        ...
                        <div class="grid grid-cols-3 lg:grid-cols-1 gap-2">
                            <a href="<?= productFilterUrl([
                                ...
                                class="text-center lg:text-left block px-3 lg:px-4 py-3 rounded-full font-bold transition <?= empty($filters['stock_filter']) ? 'bg-slate-950 text-white' : 'bg-slate-50 hover:bg-green-50 text-slate-700' ?>">
                                Tất cả
                            </a>
                            ...
                            <a href="<?= productFilterUrl([
                                ...
                                class="text-center lg:text-left block px-3 lg:px-4 py-3 rounded-full font-bold transition <?= ($filters['stock_filter'] ?? '') === 'in_stock' ? 'bg-green-700 text-white' : 'bg-slate-50 hover:bg-green-50 text-slate-700' ?>">
                                Còn hàng
                            </a>
                            ...
                            <a href="<?= productFilterUrl([
                                ...
                                class="text-center lg:text-left block px-3 lg:px-4 py-3 rounded-full font-bold transition <?= ($filters['stock_filter'] ?? '') === 'out_of_stock' ? 'bg-rose-500 text-white' : 'bg-slate-50 hover:bg-rose-50 text-slate-700' ?>">
                                Hết hàng
                            </a>
                        </div>
                    </div>
                ...
                <?php if (!empty($products)): ?>
                    <div class="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 gap-3 sm:gap-4">
                        <?php foreach ($products as $product): ?>
                            ...
                            <div class="client-card client-card-hover overflow-hidden group">
                                <a href="<?= $productDetailUrl ?>">
                                    <div class="h-28 sm:h-32 bg-green-50 relative overflow-hidden">
                                        ...
                                        <?php elseif ($hasSalePrice): ?>
                                            <span
                                                class="absolute top-2 left-2 px-2 py-1 rounded-full text-xs font-bold bg-amber-400 text-slate-950">
                                                Sale
                                            </span>
                                        <?php endif; ?>
                                    </div>
                                ...
                                <div class="p-2.5 sm:p-3">
                                    ...
                                    <div class="grid grid-cols-1 gap-2 mt-3">
                                        <a href="<?= $productDetailUrl ?>"
                                            class="h-8 rounded-full border border-slate-200 hover:bg-green-50 text-slate-800 inline-flex items-center justify-center text-xs font-bold transition">
                                            Xem chi tiết
                                        </a>
                                        ...
                                        <form action="index.php?area=client&controller=cart&action=add" method="POST">
                                            ...
                                            <button type="submit"
                                                class="h-8 rounded-full bg-slate-950 hover:bg-slate-800 text-white inline-flex items-center justify-center text-xs font-bold w-full transition disabled:bg-slate-200 disabled:text-slate-500"
                            ...
                            <div class="join">
                                <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                                    <a href="<?= productPageUrl($queryBase, $i) ?>"
                                        class="join-item btn <?= (int)$page === $i ? 'bg-green-700 text-white border-green-700' : 'bg-white' ?>">
                                        <?= $i ?>
                                    </a>
                                <?php endfor; ?>
                            </div>
...
<section class="bg-white border-y border-slate-200">
    <div class="client-shell py-10">
        <p class="text-center text-slate-500 font-semibold mb-6">
            Đối tác và thương hiệu tin dùng
        </p>
    ...
    <div class="client-shell">
        <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
            <div>
                ...
                <p class="client-section-subtitle">
                    Thông tin hữu ích về trái cây và dinh dưỡng.
                </p>
            </div>

            <a href="index.php?area=client&controller=post&action=index" class="client-btn-outline h-11 px-5 w-fit">
                Xem tất cả
            </a>
        </div>
                ...
                <?php foreach ($posts as $post): ?>
                    <article class="client-card client-card-hover overflow-hidden">
                        ...
                        <div class="p-5">
                            <a href="index.php?area=client&controller=post&action=detail&slug=<?= urlencode($post['slug']) ?>">
                                <h3
                                    class="text-lg font-extrabold leading-6 h-12 overflow-hidden hover:text-green-700 transition text-slate-950">
                            ...
                            <a href="index.php?area=client&controller=post&action=detail&slug=<?= urlencode($post['slug']) ?>"
                                class="client-btn-outline h-9 px-4 text-sm mt-5">
                                Đọc thêm
                            </a>
                        </div>
                    </article>
