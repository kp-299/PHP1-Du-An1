        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
                ...
                <h1 class="text-3xl sm:text-5xl font-extrabold leading-tight">
                    Video ngắn và video dài
                </h1>

                <p class="text-slate-300 mt-5 leading-8 max-w-xl">
                    Trang này ưu tiên dùng link YouTube để nhẹ hosting. Video short và long được chia layout riêng.
                </p>
            </div>

            <div
                class="rounded-[2rem] bg-gradient-to-br from-pink-500 to-violet-600 min-h-64 flex items-center justify-center text-center p-8">
                <div>
...
<section class="max-w-7xl mx-auto px-3 sm:px-4 py-8">
    <form method="GET" class="grid grid-cols-1 sm:grid-cols-4 gap-3 bg-white border border-slate-200 rounded-3xl p-4">
        ...
        <select name="sort" class="select select-bordered rounded-2xl w-full">
            ...
            <option value="view_desc" <?= ($filters['sort'] ?? '') === 'view_desc' ? 'selected' : '' ?>>Xem nhiều
            </option>
        </select>
...
<section class="max-w-7xl mx-auto px-3 sm:px-4 py-10">
    <div class="flex items-end justify-between gap-4 mb-6">
        <div>
            <h2 class="text-3xl font-extrabold text-slate-950">Video ngắn</h2>
            <p class="text-slate-500 mt-2">Layout dạng vertical giống short video.</p>
        </div>
    </div>
...
<section class="max-w-7xl mx-auto px-3 sm:px-4 py-10">
    <div class="mb-6">
        <h2 class="text-3xl font-extrabold text-slate-950">Video dài</h2>
        <p class="text-slate-500 mt-2">Video dài hiển thị rộng hơn, dễ xem trên desktop.</p>
    </div>
