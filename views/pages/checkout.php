...
<section class="max-w-7xl mx-auto px-3 sm:px-4 py-8 sm:py-12">
    ...
    <form action="index.php?area=client&controller=order&action=handleCheckout" method="POST"
        ...
        <div class="lg:col-span-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <input type="text" name="customer_name"
                            class="input input-bordered rounded-2xl w-full <?= !empty($errors['customer_name']) ? 'input-error' : '' ?>"
                    ...
                    <div>
                        ...
                        <input type="text" name="customer_phone"
                            class="input input-bordered rounded-2xl w-full <?= !empty($errors['customer_phone']) ? 'input-error' : '' ?>"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="email" name="customer_email"
                            class="input input-bordered rounded-2xl w-full <?= !empty($errors['customer_email']) ? 'input-error' : '' ?>"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="customer_address"
                            class="textarea textarea-bordered rounded-2xl w-full min-h-28 <?= !empty($errors['customer_address']) ? 'textarea-error' : '' ?>"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="note" class="textarea textarea-bordered rounded-2xl w-full min-h-24"
            ...
            <div class="bg-white border border-slate-200 rounded-[2rem] p-5 sm:p-6 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <?php if ($codEnabled): ?>
                        <label
                            class="cursor-pointer rounded-3xl border border-slate-200 p-5 hover:border-green-400 transition">
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-slate-500 mt-1 leading-6">
                                        User trả tiền trực tiếp khi nhận hàng.
                                    </p>
                                </div>
                            </div>
                        </label>
                    ...
                    <?php if ($qrEnabled): ?>
                        <label
                            class="cursor-pointer rounded-3xl border border-slate-200 p-5 hover:border-green-400 transition">
                            <div class="flex items-start gap-3">
                                <input type="radio" name="payment_method" value="bank_qr" class="radio radio-success mt-1"
                ...
                <?php if ($qrEnabled): ?>
                    <div class="mt-6 rounded-[2rem] bg-slate-50 border border-slate-200 p-5">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="mt-4 space-y-3">
                                    <div class="flex justify-between gap-4 border-b border-slate-200 pb-3">
                                        ...
                                        <span class="font-bold text-right"><?= htmlspecialchars($bankName ?: '-') ?></span>
                                    </div>
                                ...
                                <div class="alert alert-warning rounded-3xl mt-5">
                                    <span>
                                        Sau khi đặt hàng, admin sẽ kiểm tra chuyển khoản và cập nhật trạng thái thanh toán.
                                    </span>
                                </div>
                            </div>
                        </div>
        ...
        <aside class="lg:col-span-4">
            <div class="lg:sticky lg:top-24 bg-white border border-slate-200 rounded-[2rem] p-5 sm:p-6 shadow-sm">
                    ...
                    <?php foreach ($cartItems as $item): ?>
                        ...
                        <div class="flex gap-3">
                            ...
                            <div class="min-w-0 flex-1">
                                <p class="font-bold text-sm leading-5 truncate">
                ...
                <div class="space-y-3">
                    ...
                    <div
                        ...
                        <span>Tổng cộng</span>
                        <span class="text-green-600"><?= number_format($totalAmount) ?>đ</span>
                    </div>
                </div>

                <button type="submit" class="btn site-gradient-bg border-0 text-white rounded-2xl w-full mt-6">
                    Đặt hàng
                </button>
