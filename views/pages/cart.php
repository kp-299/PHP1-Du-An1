...
<section class="max-w-7xl mx-auto px-3 sm:px-4 py-8 sm:py-12">
    <div class="mb-8 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
        ...
        <a href="index.php?area=client&controller=product&action=index" class="btn btn-outline rounded-2xl w-fit">
            ← Tiếp tục mua hàng
        </a>
    </div>
                                    ...
                                    <div class="sm:col-span-3">
                                        <form action="index.php?area=client&controller=cart&action=update" method="POST"
                                            ...
                                            <input type="number" name="quantity" min="1"
                                                ...
                                                class="input input-bordered rounded-2xl w-24">
            ...
            <aside class="lg:col-span-4">
                <div class="lg:sticky lg:top-24 bg-white border border-slate-200 rounded-[2rem] p-5 sm:p-6 shadow-sm">
                    ...
                    <a href="index.php?area=client&controller=order&action=checkout"
                        class="btn site-gradient-bg border-0 text-white rounded-2xl w-full mt-6">
                        Tiến hành thanh toán
                    </a>

                    <a href="index.php?area=client&controller=cart&action=clear"
                        class="btn btn-outline btn-error rounded-2xl w-full mt-3"
    ...
    <?php else: ?>
        <div class="bg-white border border-slate-200 rounded-[2rem] p-10 sm:p-16 text-center shadow-sm">
            <div class="w-20 h-20 rounded-[2rem] bg-green-50 flex items-center justify-center text-5xl mx-auto">
                🛒
            </div>
